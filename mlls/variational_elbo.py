...
class VariationalELBO(_ApproximateMarginalLogLikelihood):
    ...
    def _log_likelihood_term(self, variational_dist_f, r_dist, pi_dist, seg_bag_idx, bag_labels_gt, train_videos,  **kwargs):
        ...
        return self.likelihood.expected_log_prob(variational_dist_f, r_dist, seg_bag_idx, bag_labels_gt, train_videos, **kwargs)
    
    def forward(self, variational_dist_f, r_dist, pi_dist, seg_bag_idx, bag_labels_gt, mixing_params, train_videos, **kwargs):
        r"""
        ...
        """
        return super().forward(variational_dist_f, r_dist, pi_dist, seg_bag_idx, bag_labels_gt, mixing_params, train_videos, **kwargs)
